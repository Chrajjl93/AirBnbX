...
increaseHeightOfLogin = () => {
    ...
    Animated.timing(this.typeFieldHeight, {
...
class RegisterType extends Component {
  render(){
      this.typeFieldHeight = new Animated.Value(300)

      const acity = this.typeFieldHeight.interpolate({
          inputRange: [180, SCREEN_HEIGHT],
          outputRange: [1, 0]
      })
      const marginTop = this.typeFieldHeight.interpolate({
          inputRange: [180, SCREEN_HEIGHT],
          outputRange: [25, 100]
      })
        ...
        <View style={{flex: 1, display: 'flex', alignSelf: 'stretch'}}>
            ...
            >
                ...
                <Animatable.View animation='slideInUp' iterationCount={1}>
                    ...
                    <Animated.View style={{ height: this.typeFieldHeight, backgroundColor: 'white' }}>

                        <Animated.View style={{ opacity: acity, alignItems: 'flex-start',
